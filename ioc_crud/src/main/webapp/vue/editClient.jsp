                ...
                <div class="card-body">
                    <form method="POST" action="${pageContext.request.contextPath}/EditClient.do?idClient=${pm.idClient}">
                        <div class="mb-3">
                            ...
                            <input type="text" id="nom" name="nom" class="form-control" value="${pm.nom}" required>
                        </div>
                        <div class="mb-3">
                            <label for="prenom" class="form-label fw-semibold">Prénom Client :</label>
                            <input type="text" id="prenom" name="prenom" class="form-control" value="${pm.prenom}" required>
                        </div>
                        <div class="mb-3">
                            <label for="age" class="form-label fw-semibold">Âge :</label>
                            <input type="number" id="age" name="age" class="form-control" value="${pm.age}" required>
                        </div>
